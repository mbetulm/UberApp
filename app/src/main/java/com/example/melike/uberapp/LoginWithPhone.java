...
public class LoginWithPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FABProgressCircle fb = (FABProgressCircle)findViewById(R.id.fabProgressCircle);
        fb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LoginWithPhone.this, PasswordActivity.class);
                startActivity(i);
            }
        });
    }
    ...
    public FABProgressCircle getFabProgressCircle() {
